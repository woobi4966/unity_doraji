...
public class UIManager : MonoBehaviour
{
    ...
    // BackButton Count Variables
    int backButtonClickCount = 0;
    ...
    void Update()
    {
        ...
        if(closeFlag) // closeMenu Animation을 위한 시간 계산
        {
    ...
    public void Open_CloseInventoryBtn(){
        ...
        if(isOpenInventory != true){
            inventoryTransform.DOAnchorPos(new Vector2(0, 500), 0.5f);
